...
public class AccountAnalytics {
    ...
    public static Map<Integer, List<String>> getMapOfCounterAndStrings(List<String> list) {

        return list.stream().collect(Collectors.groupingBy(e -> Integer.valueOf(e.length()), Collectors.toList()));
    }
}
