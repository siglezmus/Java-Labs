...
public class AccountAnalyticsTest {
    ...
    @Test
    public void testGetMapOfCounterAndStrings() {
        ...
        Map<Integer, List<String>> temp = AccountAnalytics.getMapOfCounterAndStrings(names);
        ...
        Assert.assertEquals(sample,temp.get(Integer.valueOf(4)));
